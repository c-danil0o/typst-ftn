...
У наредним потпоглављима су најпре дефинисани функционални и нефункционални захтеви, након чега следи приказ предложене архитектуре.
...
- *Управљање члановима*
  ...
  - Ажурирање података постојећих чланова од стране радника
...
- *Кориснички налози и аутентификација*
  - Креирање налога за раднике са различитим улогама
...
- *Доступност, конзистентност и интегритет података*
  - Систем мора бити доступан и у случају привременог нестанка интернет конекције
...
- *Desktop апликација* - представља централни део система, инсталира се на рачунар унутар теретане и користи за управљање свим пословним процесима у теретани. Изграђена је на основу клијент-сервер архитектуре унутар једног пакета. Ова компонента је одговорна за управљање локалном базом података,
  обраду пословне логике, аутентификацију радника, креирање резеврних копија, синхронизацију са облаком и комуникацију са скенером чланских картица. Уз то, она пружа интуитиван кориснички интерфејс за раднике и администраторе.
...
Комуникација између свих компоненти је шифрована коришћењем TLS протокола како би се осигурала безбедност података током преноса.

Избор архитектуре заснован је на потреби да се обезбеди комбинација локалне поузданости и _cloud_ интеграције.
Традиционална веб (енг. _web_) решења често зависе од стабилне интернет конекције, што може бити проблематично у реалним условима рада теретана.
...
- *User* - представља радника у теретани који користи десктоп апликацију. Садржи основне податке као што су корисничко име, хеширана лозинка и улога (администратор или радник). Омогућава аутентификацију и контролу приступа унутар апликације.
...
Процес почиње када радник у апликацији изабере опцију за додавање новог члана. Затим се уносе и проверавају основни подаци o члану. Радник користи бар-код скенер или ручно уноси број нове чланске картице.
...
Ако члан постоји, проверава се статус његове чланарине. У зависности од статуса, систем одлучује да ли ће дозволити или одбити приступ.
...
Процес синхронизације може бити инициран ручно од стране радника или аутоматски у позадини. Аутоматско иницирање дешава се у случају неке битне промене над подацима која захтева тренутну синхронизацију и периодично у подешеном интервалу.
