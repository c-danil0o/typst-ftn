...
Архитектура система _GymMan_ је осмишљена као хибридно решење које комбинује локалну апликацију са _cloud_ инфраструктуром.
...
GymMan, као offline-first систем, пружа пуну функционалност чак и у одсуству мреже, уз каснију синхронизацију података са _cloud_-ом.
Овакав приступ омогућава најбољи баланс између аутономије, безбедности и једноставности коришћења и инсталације.

=== Дијаграм класа

На слици @fig:diagram-klasa приказан је UML дијаграм класа који представља структуру система _GymMan_. Систем није имплементиран коришћењем објектно оријентисаног програмског језика, али прилагођени дијаграм класа ипак може пружити јасан преглед главних ентитета у систему и њихових међусобних односа.
...
- *EntryLog* - евидентира сваки улазак члана у теретану. Садржи временску ознаку уласка, идентификатор и број картице члана који је приступио објекту. Не постоји ограничење на број уноса за једног члана.
  Такође садржи информације о статусу уласка и покрива све случајеве (валидна чланарина, пробни тренинг, истекла чланарина, прекорачен број улазака). У пољу _notes_ чувају се детаљи одбијања уласка.
...
Процес синхронизације може бити инициран ручно од стране запосленог или аутоматски у позадини. Аутоматско иницирање у случају неке битне промене над подацима која захтева тренутну синхронизацију и периодично у подешеном интервалу.
...
За сваку промену, систем покушава да је пошаље на _cloud_ сервис и чека потврду о успешном пријему. У случају грешке, систем бележи неуспешну синхронизацију и наставља са следећом променом.
