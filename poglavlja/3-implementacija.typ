...
Десктоп апликација представља централну компоненту система GymMan, осмишљену као главни алат за администраторе и запослене у фитнес центру. За њену израду изабран је радни оквир
